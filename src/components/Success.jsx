...
const Success = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="flex flex-col items-start justify-start w-full bg-black p-8 md:p-16 lg:p-section"
    >
      ...
      <div className="flex flex-col md:flex-row items-start justify-start text-white w-full gap-10 md:gap-16 lg:gap-24 mt-12 md:mt-16">
        <div
          className={`flex flex-col items-start justify-start w-full md:w-1/2 mb-10 md:mb-0 transition-all duration-1000 ${
            isVisible.leftText
          ...
          <div className="w-full mt-4">
            ...
            <div
              className={`transition-all duration-3000 ${
                isVisible.model ? "opacity-100 scale-100" : "opacity-0 scale-75"
              }`}
            >
              <model-viewer
        ...
        <div
          className={`flex flex-col items-start justify-start w-full md:w-1/2 transition-all duration-1000 ${
            isVisible.rightText
              ? "translate-y-0 opacity-100"
              : "translate-y-10 opacity-0"
          }`}
