...
const Services = () => {
  ...
  return (
    <section id="services" className="w-full bg-[#080808] border-t border-white/10 relative z-10">
      <div className="flex flex-col lg:flex-row min-h-screen pt-24 lg:pt-0 w-full max-w-[1700px] mx-auto">
        
        {/* --- LEFT: STICKY INFO BLOCK --- */}
        <div className="w-full lg:w-[35%] lg:h-[100svh] lg:sticky lg:top-0 px-6 md:px-8 lg:px-12 py-12 lg:py-16 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col justify-center gap-12 lg:gap-32 relative overflow-hidden bg-[#080808]">
          <TechGrid opacity="opacity-70" maskPosition="center 30%" />
          ...
          >
            <motion.div variants={fadeUpVars} className="flex items-center gap-3 mb-8">
              <span className="text-[#FFC800] font-mono text-tech-label">INDEX [01]</span>
              <div className="h-px w-8 bg-[#FFC800]"></div>
            </motion.div>
            
            <motion.h2 
              variants={titleContainerVars}
              className="text-fluid-h2 font-bold tracking-tightest uppercase leading-none"
            >
            ...
            <motion.p 
              variants={fadeUpVars}
              className="mt-6 lg:mt-8 text-fluid-body text-white/50 uppercase font-mono tracking-tight max-w-sm"
            >
          ...
          >
            <div className="font-mono text-tech-label text-white/30 uppercase mb-2">Operation Mode</div>
            <div className="flex items-center gap-2">
              ...
              ></motion.div>
              <span className="text-tech-label font-bold text-[#FFC800] uppercase">Full Automation // Active</span>
            </div>
          </motion.div>
        </div>
