...
const Preloader = ({ onComplete }) => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // 5. Monolithic Curtain Whip (Pure Brutalist Reveal)
      tl.to(".curtain", {
          yPercent: -100,
          duration: 1.4,
          ease: "expo.inOut"
  ...
  return (
    <div ref={overlayRef} className="fixed inset-0 z-[999] bg-transparent flex flex-col items-center justify-center pointer-events-none">
      ...
      {/* Center: The Wasp Canvas (Sharp Vectors, No Blooms) */}
      <div className="preloader-ui relative z-10 flex flex-col items-center justify-center w-full h-full pointer-events-none">
      ...
      <div className="preloader-ui absolute bottom-12 right-12 flex items-baseline z-10 select-none">
        ...
        <span className="text-[3vw] md:text-[2vw] text-[#FFC800] leading-none ml-2 mb-3 self-end font-mono tracking-widest font-bold">
          %
        </span>
      </div>
